...
after_initialize do
  ...
  register_mcp_tool(
    ...
    input_schema: { type: "object", properties: { post_id: { type: "integer", minimum: 1 }, reaction: { type: "string", minLength: 1, maxLength: 100 } }, required: %w[post_id reaction], additionalProperties: false },
