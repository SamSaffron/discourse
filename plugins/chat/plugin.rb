...
after_initialize do
  ...
  register_mcp_tool(
    ...
    description: "Lists chat channels followed by the authenticated user, including direct-message channels.",
  ...
  register_mcp_tool(
    ...
    input_schema: { type: "object", properties: { channel_id: { type: "integer", minimum: 1 }, limit: { type: "integer", minimum: 1, maximum: 100 } }, required: ["channel_id"], additionalProperties: false },
    required_scopes: %w[chat:read],
    annotations: { readOnlyHint: true, destructiveHint: false },
    availability: -> { SiteSetting.chat_enabled },
  )
  register_mcp_tool(
    ...
    input_schema: { type: "object", properties: { channel_id: { type: "integer", minimum: 1 }, message: { type: "string", minLength: 1 }, thread_id: { type: "integer" }, reply_to_message_id: { type: "integer" } }, required: %w[channel_id message], additionalProperties: false },
